...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // --- 1. Translations System ---
    ...
    const translations = {
        ...
        'hero-loc-tag': { en: 'UAE & KSA', ar: 'الإمارات والسعودية' },
        'hero-title-solid': { en: 'TURNING SPACE', ar: 'تحويل المساحات' },
        'hero-title-accent': { en: 'INTO EXPERIENCE', ar: 'إلى تجارب ملموسة' },
        'about-tag-header': { en: 'ABOUT WHITELEAF', ar: 'عن وايت ليف' },
        'about-statement-text': { en: 'We are a premier spatial experience studio in Dubai & Riyadh. We push boundaries, architect environments, and shape change.', ar: 'نحن استوديو رائد للتجارب المكانية في دبي والرياض. نتجاوز الحدود، ونصمم البيئات، ونشكل التغيير.' },
        'read-more-btn': { en: 'READ MORE ↓', ar: 'اقرأ المزيد ↓' },
        'works-title': { en: 'WORKS', ar: 'أعمالنا المميزة' },
        'p1-title-text': { en: 'LEAP Riyadh Stage', ar: 'مسرح مؤتمر ليب الرياض' },
        'p1-cat-text': { en: 'Events // Stage Architecture', ar: 'الفعاليات // تصميم المسارح' },
        'p2-title-text': { en: 'FedEx Trade Pavilion', ar: 'جناح فيديكس التجاري' },
        'p2-cat-text': { en: 'Exhibitions // Double Decker', ar: 'المعارض // طابقين' },
        'p3-title-text': { en: 'Lexus Luxury Launch', ar: 'عرض لكسز الفاخر' },
        'p3-cat-text': { en: 'Activations // Brand Experience', ar: 'تجارب العلامات التجارية' },
        'p4-title-text': { en: 'BMW XM Pavilion', ar: 'جناح بي إم دبليو XM' },
        'p4-cat-text': { en: 'Exhibitions // Custom Pavilion', ar: 'المعارض // جناح مخصص' },
        'p5-title-text': { en: 'Porsche Summit Stage', ar: 'مسرح قمة بورش' },
        'p5-cat-text': { en: 'Events // Experiential', ar: 'الفعاليات // مسرح تجريبي' },
        'p6-title-text': { en: 'Gitex Tech Pavilion', ar: 'جناح جيتكس للتكنولوجيا' },
        'p6-cat-text': { en: 'Exhibitions // Technology', ar: 'المعارض // تكنولوجيا' },
        'tag-events': { en: 'EVENTS', ar: 'الفعاليات' },
        'tag-exhibitions': { en: 'EXHIBITIONS', ar: 'المعارض' },
        'tag-interiors': { en: 'INTERIORS', ar: 'التصميم الداخلي' },
        'tag-activations': { en: 'ACTIVATIONS', ar: 'تجارب العلامات' },
        'card-title-1': { en: 'LEAP RIYADH — FUTURE TECH STAGE', ar: 'مؤتمر ليب الرياض — مسرح التكنولوجيا المستقبلية' },
        'card-title-2': { en: 'GITEX GLOBAL — SECURITY CISO LOUNGE', ar: 'جيتكس دبي — صالة الأمن السيبراني' },
        'card-title-3': { en: 'DIFC DUBAI — EXECUTIVE HQ INTERIOR', ar: 'مركز دبي المالي — التصميم الداخلي للمقر الرئيسي' },
        'card-title-4': { en: 'CRAFTED FOR LEXUS — EXPERIENTIAL CAMPAIGN', ar: 'عرض لكسز الفاخر — حملة التفاعل والتجربة' },
        'card-btn-1': { en: 'VIEW EVENT PROJECTS →', ar: 'عرض مشاريع الفعاليات ←' },
        ...
        'contact-tag-txt': { en: 'GET IN TOUCH', ar: 'تواصل معنا' },
        'contact-heading-txt': { en: 'START A PROJECT', ar: 'ابدأ مشروعك معنا' },
        'contact-sub-heading': { en: 'We engineer interior environments, exhibition pavilions, and brand experiences across Dubai & Riyadh.', ar: 'نقوم بتصميم وتنفيذ المساحات الداخلية، وأجنحة المعارض، وتجارب العلامات التجارية في دبي والرياض.' },
        'contact-offices-title': { en: 'REGIONAL OFFICES', ar: 'المكاتب الإقليمية' },
        'contact-offices-desc': { en: 'Dubai, UAE • Riyadh, KSA', ar: 'دبي، الإمارات • الرياض، السعودية' },
        'contact-direct-title': { en: 'PHONE & WHATSAPP', ar: 'الهاتف والواتساب' },
        'contact-email-title': { en: 'EMAIL INQUIRIES', ar: 'البريد الإلكتروني' },
        'contact-submit-btn': { en: 'SEND MESSAGE →', ar: 'إرسال الرسالة ←' },
